    ...
    >
      ...
      <div className="flex gap-3 flex-wrap justify-center">
        <a
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-bold tracking-wide transition-all duration-200 hover:scale-105 active:scale-95"
          style={{ backgroundColor: '#25D366', color: '#fff', fontFamily: 'var(--font-montserrat)' }}
        >
        ...
        <a
          ...
          rel="noopener noreferrer"
          id="footer-ig-btn"
          className="flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-bold tracking-wide transition-all duration-200 hover:scale-105 active:scale-95 text-white"
          style={{
      ...
      {/* Separador */}
      <div className="w-20 h-px" style={{ backgroundColor: 'rgba(255,255,255,0.2)' }} />
